...
const uint8_t body_packet[] = {
    0x10, 0xA9, 0x00, 0xFF, 0xAE, 0xFD, 0x40, 0x40, 0x6F, 0x00, 0xDE, 0x75, 0x80, 0x00
};

// State that represents shutter button half-press
const uint8_t body_packet_ready[] = {
    0x10, 0xA9, 0x00, 0xFF, 0xAE, 0xFD, 0x40, 0x40, 0x6B, 0x00, 0xDE, 0x75, 0x80, 0x00
};

// Pre-flash initialization packet
const uint8_t body_packet_pf[] = {
    0x10, 0xA9, 0x00, 0xFF, 0xAE, 0x7D, 0x40, 0x40, 0x4B, 0xF4, 0xC0, 0x75, 0x80, 0x00
};

// Exposure flash correction packet
const uint8_t body_packet_ef[] = {
    0x10, 0xA9, 0x00, 0xFF, 0xAE, 0x7D, 0x40, 0xC0, 0x5B, 0xDF, 0xC0, 0x75, 0x80, 0x00
};
