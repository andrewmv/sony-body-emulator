...
uint8_t body_packet_standby[] = {
    // 0x28,0x9C,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x6E,0x00,0xE3,0x75,0x80,0x00    // F43 WL
    // 0x21,0xA9,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x6E,0x00,0xDE,0x75,0x80,0x00    // AirPro
    0x28,0x98,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x6E,0x00,0xE3,0x75,0x80,0x00     // S2 28mm 1/250 ISO100 F2.8 WL
};

// State that represents shutter button half-press
uint8_t body_packet_ready[] = {
    // 0x28,0x9C,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x6A,0x00,0xE3,0x75,0x80,0x00    // F43 WL
    // 0x21,0xA9,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x6A,0x00,0xDE,0x75,0x80,0x00    // AirPro
    0x28,0x98,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x6A,0x00,0xE3,0x75,0x80,0x00     // S2 28mm 1/250 ISO100 F2.8 WL
};

// Pre-flash initialization packet
uint8_t body_packet_pf[] = {
    // 0x28,0x9C,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x4A,0xFC,0xC0,0x75,0xF8,0x78    // F43 WL
    // 0x21,0xA9,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x5A,0xF8,0xC0,0x75,0xF1,0x71    // AirPro
    0x28,0x98,0x2B,0xFF,0xAE,0x7D,0x80,0x40,0x4A,0xFC,0xC0,0x75,0xF8,0x78     // +0.7
};

// Exposure flash correction packet
uint8_t body_packet_ef[] = {
    // 0x28,0x9C,0x2B,0xFF,0xAE,0x7D,0x80,0xC0,0x7A,0xDF,0xC0,0x75,0xBF,0x3F    // F43 WL
    // 0x21,0xA9,0x2B,0xFF,0xAE,0x7D,0x80,0xC0,0x6A,0xF0,0xC0,0x75,0xC8,0x48    // AirPro
    0x28,0x98,0x2B,0xFF,0xAE,0x7D,0x80,0xC0,0x6A,0xF3,0xC0,0x75,0xC8,0x48     // +0.7
};
